...
The residential real estate industry is undergoing a fundamental shift from traditional, paper-heavy processes to a frictionless e-commerce model. Despite being a primary "B2C" (Business-to-Consumer) sector, real estate has historically lagged behind other industries in digitization by approximately 40 years. This document summarizes key insights from industry leaders Jason Hardy (CEO of Ownly) and Shane Wenzel (CEO of Shane Homes) regarding the evolution of PropTech, the launch of "Ownly Verified," and the critical role of transparency in high-value consumer transactions.
...
## **The Genesis and Mission of Ownly**

### **Conceptual Origin**

The concept for Ownly was born in mid-2019, pre-dating the pandemic-driven shift toward digital services. Founder Jason Hardy conceived the idea after a frictionless online vehicle purchase, noting the stark contrast between buying a car and the "stressful" administrative "red tape" associated with purchasing a home.
...
| Feature | Description |
| :---- | :---- |
| **Build and Price Tool** | Allows consumers to review models and communities, increasing website engagement time from minutes to over an hour. |
| **Ownly Verified** | A proprietary, patent-pending flagship product launching in mid-2023. It serves as a "sales enablement tool" rather than a replacement for brokers. |
| **5-Stage Verification** | Includes identity credential verification, mortgage pre-approval, income/liability verification, soft credit checks, and real-time home valuations. |
| **E-commerce Integration** | Features a shopping cart experience where buyers can place deposits and sign purchase agreements online. |
...
Shane Wenzel notes that consumer priorities have shifted significantly since 2008, with transparency becoming a top priority.

* **"Buy vs. Sold":** Consumers want the opportunity to buy through self-education rather than the feeling of being "sold" by a salesperson.  
* **Remote Transactions:** There is an increasing trend of out-of-province buyers (e.g., from Ontario or British Columbia moving to Alberta) completing entire verification and purchase processes remotely.

### **Industry Forecasts**

The real estate sector is moving toward "Office 2.0" and "fully integrated neighborhoods" where residents can live, work, and play for decades.

* **Transaction Failure Rates:** Currently, 50% of U.S. real estate transactions fail in the "11th hour" due to a lack of communication and transparency. Verified buyer tools are positioned to solve this.  
* **Economic Outlook:** While global markets face a slowdown due to interest rates, leaders argue this is a "blessing" for PropTech. It forces sellers to adopt tools that allow them to sell more homes with fewer resources.

\--------------------------------------------------------------------------------

## **Entrepreneurial Insights and Scaling**
...
Mentorship is cited as the "backbone" of successful PropTech ventures. Key entrepreneurial advice included:

* **Vulnerability:** Founders must be "coachable" and act as "sponges" for information.  
* **Team Buy-In:** No new digital policy or marketing plan succeeds without total buy-in from the internal team (the "tail wagging the dog" scenario).  
* **Cross-Industry Learning:** Entrepreneurs are encouraged to "get outside their box" and learn from pitfalls in unrelated industries.

\--------------------------------------------------------------------------------

## **Key Quotes**

"Real estate is truly the last B2C industry on the planet that's digitized the buying process. There's no real reason for it." — **Jason Hardy**

"When it comes to real estate, nobody wants to be sold. People want the opportunity to be able to educate themselves and they want the opportunity to buy rather than be sold." — **Jason Hardy**

"Unless you have complete buy-in from your team, implementing any new direction... is going to fail. You need buy-in right from the top down." — **Shane Wenzel**

"We're building homes for people to live in now as opposed to simply for resale." — **Shane Wenzel**

# Episode 002

# **Virtuo: The Evolution of Homeownership**
...
## **Key Entities and Speakers**

| Entity | Representative | Role | Focus |
| :---- | :---- | :---- | :---- |
| **Virtuo** | Casey | CEO & Co-founder | Smart home management and moving concierge services. |
| **Brookfield Properties** | Chris Richer | SVP Alberta Homes | Management of single and multi-family residential construction. |
| **Colliers** | Josh | Senior Associate | Occupier Services (Tenant representation in Calgary). |
| **InterGen** | Kyle Beckhamert | Venture Lead | Facilitator of the PropTech Breakfast Club. |
...
The discussion revealed a significant misalignment between industry assumptions and actual customer needs regarding support services.

* **High Emotional Stakes:** Contrary to expectations that high-end "estate" buyers would value concierge services most, the highest engagement comes from first-time buyers and new Canadians.  
* **The Surprise Metric:** For first-time buyers, the level of emotional investment and passion is higher than for retirees or luxury buyers. These customers view the home not as a commodity, but as a hard-earned milestone, making them more sensitive to experience failures.  
* **Demographic Influx:** There is a notable trend of buyers moving from Ontario and British Columbia to Alberta, seeking affordability and a "vibrant, livable" environment.

### **4\. Industry Trends and Challenges in Alberta**
...
"Buying a home is extremely exciting and awesome until the next day when you realize you don't have internet, you move in, and you forgot about the mail." — **Casey, Virtuo**

"Luck is where preparation meets opportunity... Virtuo comes along at a time where the alignment of value proposition is almost perfect." — **Chris Richer, Brookfield Properties**

"I always thought the customer would get easier as we went down market; it actually gets more difficult... the emotions are high and this is an emotional purchase." — **Chris Richer, Brookfield Properties**

"The only people who should be learning in a startup at our stage are the founders; everybody else should have been there, done that." — **Casey, quoting a mentor**

# Episode 003

# **Bōde: Modernizing the Residential Real Estate Transaction through Technology**
...
## **Genesis and Core Mission**

### **The Catalyst for Innovation**

The company was founded following CEO Robert Price’s personal experience selling a property in 2017\. Despite performing the majority of the "intellectual work"—including pricing research, negotiation scripts, and buyer vetting—Price paid a $50,000 commission to an agent whose role felt primarily administrative. This friction point led to the realization that the industry lacked a digital, online option for those capable of managing their own transactions.

### **Founders and Vision**

The founding team includes Robert Price (former CEO of Axia) and Jeff, a former broker of a 50-agent brokerage. This partnership blends outsider tech innovation with deep industry domain expertise. The core mission is to:

* **Elevate and modernize** the residential industry through smart technology.  
* **Eliminate friction** in the buying and selling process.  
* **Empower consumers** by demystifying the complexity of real estate transactions.
...
| Feature | Details |
| :---- | :---- |
| **Financial Impact** | Average builder earns an additional $500,000 in bottom-line profit per year. |
| **Subscription Model** | Monthly fee with a one-year contract for unlimited listings. |
| **Strategic Flexibility** | Builders can list properties at any phase: pre-construction, mid-construction, or complete. |
| **Data Transparency** | Provides transaction and market data at the individual customer level, which many large builders previously lacked. |

\--------------------------------------------------------------------------------

## **Technological Capabilities and Market Expansion**
...
* Leveraging a centralized team rather than hiring local consultative staff.
...
* **Control:** Sellers can mandate that buyers be ID-verified before they are allowed to view a property.
...
A major upcoming feature is a digital auction tool designed to address specific pain points:

* **Transparency:** Moves negotiations out of "backrooms" and into an open, predetermined format.  
* **Efficiency:** Eliminates the negotiation and condition removal phases.  
* **Flexibility:** Sellers can set a reserve price and toggle between a traditional listing and an auction at the click of a button if they receive multiple competing offers.

\--------------------------------------------------------------------------------

## **Industry Dynamics and Competitive Stance**
...
Robert Price emphasizes several winning conditions for scaling a startup in a volatile environment:
...
# **ZS2 Technologies: Sustainable Construction Innovation**
...
* **Scott Jenkins (Co-founder and CEO):** Former President of DIRTT Environmental Solutions. He led DIRTT from $6 million to $300 million in annual sales and oversaw its IPO on the Toronto Stock Exchange.  
* **Dr. Doug Brown (Co-founder and Chief Scientist):** A PhD chemist and expert in carbon capture, previously associated with Carbon Engineering and a finalist in the Elon Musk-funded Carbon Removal XPRIZE.  
* **Matt Grieve (Board Member/Investor):** President of Magnum Ventures, providing expertise in real estate development and capital markets.  
...
| Feature | Traditional Portland Cement | ZS2 Magnesium Cement |
| :---- | :---- | :---- |
| **Primary Source** | Limestone (CaCO3) | Magnesium Oxide (MgO) |
| **Carbon Impact** | 1 ton CO2 released per 1 ton cement | Binds with CO2; 70% reduction in footprint |
| **Manufacturing Heat** | 1,500°C required | Significantly lower requirements |
| **Physical Properties** | Standard weight and strength | 1/3 the weight; up to 3x the strength |
| **Curing Time** | Long (e.g., weeks/months) | 1/7th the time of traditional cement |
| **Resistance** | Standard | Fire-rated, anti-microbial (mold-resistant) |
...
The primary product is a structural insulated panel (SIP) described as an "Oreo cookie" construction:

* **Outer Layers:** Magnesium cement board.  
* **Core:** High R-value rigid insulation (extruded polystyrene).  
* **Value Proposition:** These panels provide cost certainty, accelerate construction timelines, and exceed energy efficiency requirements (such as California’s Title 24).
...
* **Year 1:** $78,000  
* **Year 2:** $398,000  
* **Year 3 (Recent):** \~$2,000,000  
* **Year 4 (Projected):** $6,000,000 – $8,000,000  
* **Sales Pipeline:** $151,000,000 (including $31 million in final stage/PO status).
...
The company leverages the "Alberta Advantage," specifically the expertise and resources available in the Western Canadian energy and mining sectors.
...
The company’s long-term roadmap includes moving from Precast products into "Ready Mix" solutions. This would allow magnesium cement to be used on a global scale for foundations and infrastructure, providing a path to sequestering one gigaton of CO2 annually.

# Episode 005

# **Eavor Technologies: The Evolution of Closed-Loop Geothermal Energy**
...
* **Traditional Geothermal:** Requires a "constellation" of specific conditions: heat, an aquifer, and high rock porosity/permeability. Water must flow through the rock itself to collect heat. If the rock is dry or impermeable, the well fails.  
* **Eavor-Loop:** A closed-loop system where water is sealed within the wellbores. It does not rely on the rock's ability to move water. Instead, the system functions like a subsurface radiator, circulating fluid that collects heat through conduction from the surrounding rock.
...
Paul Cairns, Chief Business Development Officer, describes the initial commercialization phase as a necessary sacrifice to prove the technology:

"We’re going to go first. We’re going to build the first one. We’re going to lose our ass and then we’re going to come down the learning curve... so that there will be people to go second."

### **Evolution to Licensing**
...
* **Key Personnel:**  
  * **John Redfern:** CEO and Co-founder.  
  * **Paul Cairns:** Co-founder and Chief Business Development Officer.  
  * **Shanley Muhammad:** CFO, focusing on global structure and capital raising.  
* **Advisors:**  
  * **Michael Liebreich:** Renowned clean tech expert.  
  * **Jesse Jenkins:** Special advisor to the White House and Department of Energy (USA).
...
# **Pure Life Carbon Inc: Sustainable Agriculture and Carbon Sequestration**
...
Pure Life Carbon was founded roughly six years ago by Don Ronald, Chris Vance, and Ryan Rand. The company’s mission is to create clean technologies that "protect and heal the environment while enhancing food production and increasing yields." The technology itself is the result of over 15 years of research by Dr. Nick Savinoff, an expert in growing mediums who sought to create an environmentally friendly alternative to the GHG-intensive substrates currently dominating the market.

### **Core Objectives**

* **Food Security:** Enhancing global food production capabilities.  
* **Environmental Remediation:** Cleaning pollutants from water, soil, and air.  
* **Decarbonization:** Replacing peat moss, the extraction of which is a major source of land degradation and carbon emissions.

\--------------------------------------------------------------------------------

## **Technological Innovation: Purpose-Built Carbon**

PLC distinguishes its product from "biochar," a generic term for biomass-derived carbon. While biochar is often a byproduct used for soil augmentation, PLC’s product is a "purpose-built carbon" designed specifically as a 100% soilless growing medium.

| Feature | Pure Life Carbon Medium | Traditional Mediums (Peat/Rockwool) |
| :---- | :---- | :---- |
| **Durability** | Non-degrading (26+ growing cycles proven) | Single-use; degrades quickly |
| **Water Usage** | 70–80% reduction in requirements | High water consumption/runoff |
| **Sustainability** | Carbon-negative (sequesters carbon) | High GHG emissions (approx. 10% of global total) |
| **Sterility** | Naturally sterile | Rockwool contains natural asbestos; others carry pathogens |
| **Yield Impact** | Significant enhancement in food quality and yield | Standard yields; high crop loss risk |
...
## **Business Model: "Substrate as a Service" (SaaS)**

PLC is disrupting the traditional "sales and disposal" model of the agricultural industry through a circular leasing economy.

* **Leasing Model:** Instead of selling the medium as a commodity, PLC "rents the dirt" to greenhouses. This provides growers with surety of costs and removes the burden of waste disposal.  
* **Recycling and Recharging:** After a growth cycle is complete, PLC retrieves the medium, puts it through a specialized recycling/recharge facility, and sends it back out for use.  
* **Asset Compounding:** Every year, the company’s inventory grows, creating a fleet of assets that do not degrade, which the company anticipates will generate significant free cash flow.

\--------------------------------------------------------------------------------

## **Operations and Supply Chain Vertical Integration**

The company is currently moving to vertically integrate its entire value chain to ensure consistency and sustainability.

1. **Forestry (Upstream):** Moving supply from China to Mexico. PLC has secured land in Mexico to sustainably farm bamboo, a fast-growing grass that can grow up to 12 inches per day.  
2. **Carbonization (Midstream):** The bamboo undergoes a proprietary pyrolysis process. This step is carbon-negative and generates clean energy as a byproduct.  
3. **Processing (Downstream):** The resulting carbon molecules are shipped to Red Deer, Alberta, where they undergo a proprietary chemical treatment to become the final growing medium.
...
The primary focus is **Controlled Environment Agriculture (CEA)**, specifically greenhouses. These businesses are characterized by:

* High capital intensity and high volume.  
* Extremely thin, single-digit margins.  
* A need for consistent, sterile environments to prevent crop loss.

### **Adoption Barriers**

* **Long Sales Cycles:** Proving the product takes time. PLC has conducted over 80 trials globally (North America and Europe), each typically lasting one to two years to show full crop maturity.  
* **Risk Aversion:** Growers are often hesitant to change their primary growing medium due to the high risk associated with fine margins.  
* **Capital Access:** Raising significant capital in the Canadian AgTech space is difficult, particularly outside of the energy sector in Alberta.
...
* Proving the end-to-end value proposition to prepare for global expansion into Europe, Asia, and India.

\--------------------------------------------------------------------------------

## **Sustainability and Carbon Credit Strategy**
...
"The growing medium itself... has no degradation and performance through time... That turns our business model from a sales model into a leasing model. We effectively rent the dirt." — **John Horseman, CFAO**

"We always thought it was all about creating a product that costs similar but was recyclable... what we didn't realize is it really significantly enhances the quality of the food. We make a better tomato." — **Gordon Anderson, Director**

"Trying to map bamboo from a carbon perspective is incredibly difficult... there’s 1500 species of bamboo... we’ll be only the second \[company\] that’s going to be able to monetize a forestry bamboo project." — **Chris Vance, Sustainability Leader**

# Episode 007

# **Trust Science: The Evolution of Credit Underwriting**
...
Trust Science was founded by Evan Schrepko and his brother Shane as a "passion project" to remove human bias and "gut feeling" from business trust assessments. The company emerged from a decade-long "stealth mode" to ensure its AI and ML infrastructure reached commercial maturity.

### **Leadership Background**

* **Evan Schrepko (CEO):** A serial entrepreneur with a track record of significant exits, including Dockspace (568M), PlateSpin (205M), and Flow Networks ($80M). He is a CPA, holds a Columbia University law degree, and is recognized in the "Real Leaders Global 100."  
* **Colin Tran (VP Corporate Affairs):** A recognized industry leader and the youngest honoree in the history of "Auto Remarketing’s Under 40." He oversees marketing, business development, and strategy.

\--------------------------------------------------------------------------------

## **2\. The Core Innovation: "Credit Bureau 2.0"**

The platform aims to replace or augment traditional credit bureaus (FICO in the US, Beacon/Vantage in Canada), which are characterized as a 1950s-era monopoly that creates a "Credit Catch-22."

### **The "Invisible Prime" Segment**
...
* **Primary Customers:** Banks and lenders in automotive finance, installment lending ($10,000 range), and point-of-sale Retail Finance.  
* **Value Proposition (USP):**  
  * **Predictive Lift:** 40% to 60% statistical improvement in predictive accuracy over competitors.  
  * **Risk Mitigation:** Allows lenders to expand their "credit box" into the subprime market without increasing actual risk.  
  * **Operational Efficiency:** Optimizes deal terms (interest rates, down payments) and reduces the need for manual adjudication.

### **Business Model and Revenue**

The company avoids "teaching the market a new way to buy" by mimicking existing procurement models:

* **Marketing:** Targeted at Chief Marketing Officers (CMOs) to find creditworthy leads at the top of the funnel.  
* **Risk/Adjudication:** Sold as a per-score or per-decision fee, typical for Chief Risk Officers.  
* **Capital Markets:** For CFOs and asset-light lenders, the service assists in valuing asset-backed securities (ABS) and inform negotiations for loan books.
...
* **ML Ops Platform:** The company invested heavily (double-digit millions) to build a bona fide machine learning platform that thrives on "chaos" and stimuli, such as the economic gyrations of 2020 and recent inflation/interest rate shifts.  
* **Compliance:** The platform is built to pass rigorous security, scalability, and legal compliance audits (e.g., CFPB in the US), a necessity for working with major financial institutions like TD Bank.
...
| :---- | :---- |
| **Global Recognition** | \#4 Fastest Growing FinTech (Western Hemisphere); Real Leaders Global 200\. |
| **Patent Estate** | 55+ granted; many more pending. |
...
# **Fillip Fleet and Staircase Ventures**

## **Executive Summary**

This briefing document synthesizes the insights from the InterGen FinTech Breakfast Club featuring Alice Reimer, CEO of Fillip Fleet, and Janet Bannister, General Partner of Staircase Ventures. The discussion centers on the digital transformation of the legacy fleet fuel card industry and a novel approach to venture capital that prioritizes founder development alongside business growth.
...
Originally founded to allow individual consumers to lock in fuel prices, the company underwent a "hard right pivot" in January 2021\.

* **B2C Limitations:** The original model struggled with monetization and was only attractive when gas prices were rising.  
* **B2B Opportunity:** The team identified that 75% of Canadian retail gas stations are independently owned and operated, yet these operators and their small business customers were underserved by legacy technology.

### **The Problem and Solution**

The fleet card market is estimated at $300 billion in North America, but it remains largely dependent on outdated technology.

| Feature | Legacy Fleet Cards | Fillip Fleet Solution |
| :---- | :---- | :---- |
| **Technology** | Proprietary rails, physical magstripe cards | Mobile-first, digital cards on the Visa network |
| **Control** | Limited; prone to fraud/general spending | Real-time visibility; restricts spending to fuel/vehicle needs |
| **Data** | Sparse; manual expense tracking | Automated data integration for vehicle/driver tracking |
| **Accessibility** | Costly for small fleets to acquire/maintain | Rapid digital acquisition for fleets of 5–100 vehicles |
...
* **Market Expansion:** Transitioning from "micro-fleets" (5–25 vehicles) to larger fleets (25–100 vehicles) due to market pull and better unit economics.
...
Janet Bannister outlines a dual focus for investments:

1. **The Team:** Specifically looking for a "can-do" attitude, positive energy, and the technical skills required for complex industries like financial services.  
2. **The Concept:** A preference for overlooked, "boring" industries (like fuel payments) where legacy players have failed to innovate.
...
The briefing provides critical advice for entrepreneurs navigating the current economic environment:

* **Relationship Building:** Founders should start conversations with VCs a year before they need capital. "Partners want to see that you are doing what you say you're going to do."  
* **Capital Efficiency:** There is an increasing emphasis on reaching cash-flow positivity with a single raise, rather than relying on a continuous cycle of funding.  
* **Series A Readiness:** While seed markets remain robust, Series A investors now demand proven unit economics. Growth is less about historical performance and more about the predictability of future growth per dollar invested.
...
"Everybody wants to be the CEO until they're the CEO and they recognize how difficult the job itself can be." — **Alice Reimer**

"If you look at how investors add value post-investment, they add value all around the business side... What they don't focus on is helping to grow the founders themselves." — **Janet Bannister**

"Play the long game... don't be afraid of failure. You're never going to learn to hit out of the sand unless you try to hit the ball out of the sand." — **Janet Bannister (on lessons from golf)**

"I'm doing it because I want to do it... People can see through your intentions, and why you do things is just as important as what you do." — **Janet Bannister (on Staircase's founder platform)**

# Episode 009

# **ZayZoon: Revolutionizing Financial Wellness through Earned Wage Access**
...
EWA is defined as a tool for "upward financial mobility." It treats earned wages as a personal income statement item that has been accrued but not yet hit the cash flow statement.
...
| :---- | :---- | :---- |
| **Source of Funds** | Borrowing from "future self" | Accessing already earned income |
| **Cost** | Hundreds of percent in interest | $0 to $5 flat fee |
...
"The busiest day for a payday lender is payday because people have borrowed from their future selves... when you use ZayZoon, you're not borrowing from yourself. Instead of being embarrassed about it, you should be empowered because you worked hard for this." — **Darcy Tuer, CEO**
...
* **Daily Scrums:** All 110 employees participate in a 15-minute daily call featuring announcements, team presentations, and "shout-outs" tied to core values like "Mastery."  
* **Mentorship Philosophy:** The leadership views mentorship as a two-way bond where the mentee must provide value back to the mentor.  
* **Leadership Values:** Focus on resourcefulness and relentlessness. CEO Darcy Tuer emphasizes being deliberate with time, focusing on 13-week, 12-month, and 3-year horizons.
...
# **DrugBank: Enhancing Drug Discovery Through Structured Biomedical Intelligence**
...
DrugBank was founded by Michael Wilson and Craig Knox, both of whom have backgrounds in biology and computing science (bioinformatics). The project began in Dr. Wishard’s lab at the University of Alberta.
...
The transition from an academic prototype to a commercial tool was driven by identifying product-market fit in high-value sectors:

* **Early Focus:** The team investigated various markets, including reference tools for pharmacists and students, EMR integrations, and precision medicine.  
* **MVP Strategy:** The company validated its market by building Data Solutions and APIs that allowed researchers to query data directly and integrate it into their specific workflows.
...
The platform is built on a proprietary biomedical knowledge base that covers:

* **Molecular Data:** Chemical structures and drug metabolism.  
* **Biological Data:** Drug targets and pathways.  
* **Clinical Data:** Clinical trial records, side effects, and drug-drug interactions.  
* **Regulatory Data:** Patent records and drug identifiers that have become industry standards.

### **Data Scale and Quality**

| Metric | Detail |
| :---- | :---- |
| **Total Data Points** | Over 150 million |
| **Relationships/Links** | Over 500 million |
| **Annual Unique Users** | 21 million |
| **Academic Citations** | Over 40,000 |
| **Registered Users** | 100,000+ across 10,000 institutions |
...
The pharmaceutical industry is currently experiencing a revolution driven by AI, particularly in treating major diseases:
...
* **Autonomy:** Providing team members with the tools and responsibility to see the direct results of their work.

### **Mentorship and Resilience**

The leadership team emphasizes the importance of both formal and informal mentorship.

* **External Expertise:** Leveraging investors and a network of peers to unlock new growth stages.  
* **Curiosity:** Chief Strategy Officer Alexa McCarron advocates for an "always be curious" mindset, learning from other industries that may be ahead of healthcare in technology adoption.
...
3. **Efficiency Gains:** Reducing the cost and time of drug development to help patients receive novel therapies faster.
...
"We built essentially an AI researcher... Our platform goes out, it reads the literature, it reads patents, it reads clinical trial records... we make it all ready to use and ready to access." — **Michael Wilson, CEO**

"Healthcare has a 10-year lag at least on technology. Being able to learn from other folks, other industries, is really valuable." — **Alexa McCarron, CSO**

# Episode 011

# **Circle Cardiovascular Imaging: Growth, Commercialization, and Market Leadership**
...
## **The Genesis and Clinical Mission of Circle Cardiovascular Imaging**
...
* **Leadership Pair:** Greg Grodnik, a business leader with a background in medical media (co-founder of theheart.org), partnered with Dr. Matthias Friedrich, a pioneer in cardiac MRI who had been recruited to the University of Calgary.  
* **Initial Development:** Dr. Friedrich and a colleague in Berlin had begun coding the software that would become **CVI 42** out of clinical necessity.  
...
Unlike many startups that focus on their local market, Circle immediately targeted international markets where cardiac MRI adoption was more advanced.

* **Market Entry:** The company achieved its first commercial sale within six months and FDA approval within twelve months of becoming operational in 2008\.  
* **Europe and the U.S.:** Circle focused on Europe early on due to the rapid growth of the field there, while simultaneously establishing a presence in the United States.  
* **Targeting the "Pyramid":** The sales strategy prioritized high-volume, top-tier centers and "key opinion leaders" who published research. This created a trickle-down effect to community hospitals.
...
## **Technological Evolution: AI and Workflow Optimization**

The primary barrier to cardiac MRI adoption was the time required for post-processing images. Circle’s software transformed this from a manual, labor-intensive task into an automated workflow.

* **Quantitative Accuracy:** Cardiac MRI is a quantitative modality, providing data on function, tissue characterization, oxygenation, and scar quantification.  
* **Automation through AI:** Circle was an early adopter of machine learning, incorporating AI into its software as early as 2018\.  
* **Impact:** What previously required 40 to 50 manual maneuvers by a physician is now largely pre-processed and automated. This improves hospital throughput and ensures patients receive an accurate diagnosis the first time, reducing the waste of healthcare resources.

\--------------------------------------------------------------------------------

## **Capitalization and the Thoma Bravo Acquisition**

### **Funding History**

* **Angel Phase:** From 2008 to 2018, the company was primarily funded by a tight-knit community of approximately 40 angel investors in Calgary. A key benefactor was Ken Stevenson, a serial entrepreneur who provided both capital and access to his extensive network.  
...
## **Regional Context: The Alberta HealthTech Ecosystem**
...
## **Key Leadership and Organizational Insights**

| Theme | Insight |
| :---- | :---- |
| **Culture** | Circle maintained a "family-oriented" culture, involving employees' families in company activities to build a sense of purpose and belonging. |
| **Talent Retention** | Despite competition from U.S. companies offering remote work in USD, Circle emphasized in-office collaboration (3-4 days a week) to maintain cohesiveness. |
| **Execution** | Leadership emphasizes that "great ideas don't win; execution wins." This requires building a team with diverse skill sets rather than relying on a single founder. |
| **Investor Relations** | Grodnik advises treating shareholders as partners through transparent communication, noting that many of his 40 original angels did not want to exit in 2022 because they enjoyed being part of the journey. |
| **Perseverance** | Entrepreneurship is described as a "grind" that requires deep personal resilience and strong family support to weather the inevitable "bumps along the road." |

# Episode 012

# **PurposeMed: Scaling Specialized HealthTech for Underserved Communities**
...
PurposeMed originated from clinical observations made by co-founder Dr. Hussein in a Calgary emergency room. He noted a "revolving door" of patients whose underlying health issues were not being addressed by the standard system.
...
| Brand | Focus Area | Patient Scale | Revenue Contribution |
| :---- | :---- | :---- | :---- |
| **Freddy** | HIV Prevention (PrEP) | \~10,000 active patients | \~80% of total revenue |
| **Frida** | ADHD & Mental Health | \~10,000 active patients | Significant balance of revenue |
| **Foria** | Gender-affirming care | \~500 active patients | Niche/Recent launch |

### **Clinical Necessity and Statistics**

* **HIV (Freddy):** HIV rates are rising in Canada, with over 2,000 new diagnoses annually. Lifetime treatment for one HIV patient costs the healthcare system approximately $1.5 million. Freddy provides Pre-Exposure Prophylaxis (PrEP), which is 99% effective at preventing transmission. Despite its efficacy, less than 2% of Alberta physicians are licensed to prescribe it.  
* **ADHD (Frida):** An estimated 3% to 5% of Canadian adults have ADHD, but only half are diagnosed. Untreated ADHD correlates with significant social issues: 32% of individuals with ADHD do not graduate high school, and they comprise 33% of the Canadian prison population. Wait times for psychiatrists can exceed two years in provinces like British Columbia.  
* **Gender-Affirming Care (Foria):** Focuses on trans, non-binary, and intersex individuals, providing inclusive and non-judgmental care that is often difficult to find in traditional settings.

## **Business Models and Financial Strategy**

The company employs different revenue strategies depending on the nature of the care and the regulatory environment.
...
Aman Bhalla, Chief Commercialization Officer, defines product-market fit as a "feeling" where customers promote the product and the team is energized. This contrasts with earlier, unsuccessful ventures where the founders felt they were "knocking their heads against a wall."
...
# **Zedi: From Startup to Global Exit**

## **Executive Summary**

The trajectory of Zedi, an Alberta-based technology firm, provides a definitive roadmap for the evolution of an oil and gas tech startup into a global scale-up and eventual exit to a Fortune 500 company. Founded in 1987 by Dr. Toco Eto, Zedi transitioned from manual data collection to pioneering the "digital oilfield" through its Smart ALC edge device and integrated SaaS platform.

The company’s success was defined by several critical strategic pillars:

* **Persistent Innovation:** Launching digital edge devices in an analog, paper-chart-driven industry.  
...
The company applied an "intelligent strategy" where the hardware was inextricably linked to a platform.

* **Recurring Revenue:** Customers could not purchase a Smart ALC without signing up for the platform, which provided gas volume statements and regulatory compliance.  
* **Intelligence:** The value was not in the device itself but in the data-processing capability of the platform.
...
* **Strategic Advice:** Larry Spagnolo advises startups against organic international expansion: "Do not try it organically... Business is still done locally; business is still all about relationship and trust."
...
Reflecting on the multi-decade journey, Spagnolo highlights several key takeaways for tech scale-ups:

* **Focus is Mandatory:** Managing too many lines of business distracts from the core mission and complicates valuation.  
* **The "Early Adopter" is Essential:** A startup needs a vocal champion who will "scream from the hilltops" to build credibility in a conservative industry.  
...
# **SensorUp: The Evolution of Methane Emission Management**

## **Executive Summary**

The following briefing synthesizes key insights from a presentation by SensorUp, a Calgary-based technology company specializing in methane emission reduction. Originally founded as a "Sensor Web" research project by Professor Steve Liang, the company has evolved from a high-end R\&D lab serving organizations like NASA and Lockheed Martin into a specialized Enterprise Resource Planning (ERP) platform for the oil and gas industry.
...
## **2\. The Methane Emission Problem Space**

The document identifies methane as a uniquely potent greenhouse gas and a significant economic opportunity for the oil and gas sector.
...
Current methane detection is hampered by data silos. Companies use a variety of sensors (satellites for big leaks, planes for medium leaks, drones and handheld cameras for small leaks). However, these systems often deliver data in disparate formats, such as PDFs, which must be manually scraped into tools like PowerBI. This manual process is unscalable for operators with tens of thousands of sites.
...
## **5\. Leadership and Mentorship Philosophy**
...
* **Leadership Transition:** Recognizing that different stages of a company require different skills, the founder (Steve Liang) transitioned to the role of CTO, hiring **Terry Cunningham** (founder of Crystal Reports) as CEO. Cunningham brought experience in scaling enterprise software companies to multi-billion dollar valuations.  
...
# **BlueMarvel AI: The Evolution of Industrial Data Intelligence**
...
| :---- | :---- |
| **Spartan Controls** | The "Mothership." Established in 1963, it controls approximately 400 of the 700 largest industrial plants in Western Canada. Provides deep domain expertise, a 1,500-person SME pool, and established sales channels. |
| **AltaML** | An applied AI venture studio. Provided the original incubation environment, handling back-office functions (HR, Finance) so the core team could focus on solving technical market problems. |
| **BlueMarvel AI** | The resulting joint venture. It focuses on taking the data generated by the "factory floor" equipment (valves, sensors, control systems) and turning it into actionable software applications. |
...
## **II. Technological Innovation and Problem Solving**

The central challenge identified in the industrial sector is the "land of the pilot" and the failure of digital transformation due to a lack of context. Companies have invested heavily in data collection but lack the compute power or the contextual framework to use it.
...
The company's software applications are bucketed into three primary areas of focus:

1. **Safety and Risk:** Analyzing alarm and event data, bypass data, and operator touches on control systems to enhance facility safety.  
2. **Performance and Reliability:** Pulling data off large assets to optimize throughput and run facilities at an optimal level for profitability and efficiency.  
3. **Energy and Emissions:** Helping organizations manage their energy consumption and environmental footprint.
...
* **Services Arm:** A billable time model that allows for exploration and helps identify new problems that could eventually become commercializable products.  
* **Custom Solutions:** One-off builds for specific customer problems that may not have broad market applicability but provide immediate value and revenue.  
* **SAS Product:** The ultimate goal, focusing on scalable, agnostic products that work across different industrial processes (e.g., oil refineries vs. food processing plants).
...
## **IV. Leadership, Culture, and Mentorship**

The transition of leadership from the public relations and crisis management sector to industrial AI highlights the "adrenaline" and problem-solving nature of the startup environment.
...
Leadership defines mentorship as the most critical factor for growth, characterized by "real conversations about challenges."

* **Vulnerability:** A good mentee must be willing to share fears and "imposter syndrome" without the worry of being judged.  
* **Honesty:** Effective mentors (such as Grant Wild and Terry Schik) are described as those who are "honest with you" out of care, rather than just telling "sunshiny stories."
...
| Feature | Traditional Industry Standards | Falkbuilt (Echo Software) |
| :---- | :---- | :---- |
| **Platform** | Desktop-based applications | Cloud-based operating system |
| **Decision Making** | Based on unreliable cost/time data | Real-time, data-driven walk-throughs |
| **Maintenance** | High manpower (e.g., 74 people) | Lean manpower (14 people) |
| **Updates** | Slow, manual pricing/product releases | Overnight updates (similar to Tesla) |
| **Integration** | Isolated software silos | End-to-end integration with Revit/AutoCAD |
...
1. **Cost:** Lower price point than conventional construction.  
2. **Speed:** Significantly faster delivery and installation.  
3. **Reliability:** Digital identification of over 20,000 distinct pieces from fabrication to shipping ensures precision.
...
* **Monthly GMV:** Ranges from $15 million (seasonal low) to $45 million (high).  
* **Monthly Sign-ups:** Over 1,000 contractors per month.  
* **Headcount:** Approximately 40 employees, with a focus on stabilizing headcount while increasing revenue.
...
# **Nialli: A Briefing on Nancy Knowlton’s 37-Year Tech Journey**

## **Executive Summary**

This document synthesizes key insights from an interview with Nancy, a prominent technology entrepreneur with a 37-year career spanning the founding and scaling of Smart Technologies, Nuriva, and Nialli. The source context tracks her progression from a startup founder in 1987 to a leader of a multi-million dollar public enterprise, and finally to her current venture in construction technology.
...
Growth was not linear but "metered by what we could afford." Investment followed a specific sequence:

1. **Product:** Ensuring the core offering had value.  
2. **Marketing and Sales:** Concurrent investment to drive adoption.  
3. **International Expansion:** Initial expansion into the U.S., followed by Europe and Asia.

### **International Expansion and Risk Mitigation**

To enter the U.S. market without excessive overhead, the company utilized:

* **Manufacturer’s Reps:** Commission-based sales agents who were only paid upon successful sales, mitigating fixed costs.  
* **Strategic Leadership:** Hiring industry veterans like John Deutsch, who provided the "secret ingredient" of experience and networking.  
* **Centralized Operations:** International business was initially managed entirely from a Calgary base before placing personnel in foreign fields.

### **The "Robin Hood" Pricing Strategy**

At Smart Technologies, pricing was used as a competitive lever:

* **Cross-Subsidization:** Higher margins from the corporate sector subsidized the education market.  
* **Accessibility:** This allowed for lower prices in K-12 education, facilitating mass adoption while maintaining overall profitability.
...
## **IV. Leadership and Entrepreneurial Insights**
...
"We were insolvent for four or five of those years... we learned an awful lot about directness, balancing inflows and outflows... keeping calm and carrying on."

"The Greyhound never catches the rabbit... before you ever catch what you're striving for, set a new goal set it out there and you have to have a team that wants to race."
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| Eavor Technologies | ClimateTech / Geothermal | John Redfern (CEO), Paul Cairns (Chief Business Development Officer), Matt Tays, Jeanine Vany | Technology licensing | Oil and gas service companies, energy producers, municipalities, and utility companies | Eavor-Loop: a proprietary closed-loop geothermal system for conductive heat harvesting | Raised $225 million in equity; 91.6 million Euro EU Innovation grant; raising Series B | Global (Germany, Europe, USA, Canada, Japan) |
| Circle Cardiovascular Imaging | HealthTech | Greg Ogrodnik (CEO), Dr. Matthias Friedrich (Co-founder) | SaaS / Subscription and OEM partnerships | Cardiologists and cardiovascular imaging centers at hospitals | CVI 42 software; AI-driven cardiac MRI and CT imaging post-processing tools | Acquired by Thoma Bravo in 2022; previously raised 20 million CAD Series A | Global (Canada, USA, Europe, China, Japan, Australia, South America) |
| Falkbuilt | ConstrucTech | Mogens Smed, Barry Loberg(Co-founder), Nikki Smed | Distribution model (Factory Direct Branches) | Commercial office tenants, healthcare providers, and specialty spaces | Echo Software: cloud-based OS integrating design tools with manufacturing and logistics | Private capital from individuals and corporations; "gray market" for shares | Global (North America, Mumbai, Dubai, Jeddah, Riyadh) |
| Zedi | Oil and Gas Tech | Dr. Tokunosuke Ito (Founder), Mr. Don Clark (Co-founder) | SaaS and hardware sales | Upstream and midstream oil and gas producers | Smart ALC (edge automation) and Zedi Access (cloud data platform) | Acquired by Emerson in 2019 | Global (25 countries including Canada, USA, Latin America, Asia) |
| DrugBank | HealthTech | Michael Wilson (CEO), Craig Knox, Dr. David Wishard | B2B SaaS | Pharmaceutical companies, academic researchers, and healthcare professionals | AI-driven proprietary biomedical knowledge base and data-linking APIs | Raised seed round in 2020; seeking next round of financing | Global (North America, Europe) |
| SensorUp | Oil and Gas Tech | Steve Liang (Founder and CTO), Terry Cunningham (CEO) | Enterprise SaaS / Annual recurring licensing | Oil and gas companies (Super Majors) and regulatory bodies | Methane Emissions ERP; multi-sensor software platform for leak detection | Raised rounds from VanEdge Capital, InterGen Capital, Evok Innovations, and OGCI | Global (Canada, USA) |
| Trust Science | FinTech | Evan Chrapko (CEO), Shane Chrapko (Co-founder) | SaaS / Subscription and per-score transaction fees | Banks, consumer lenders, and automotive finance companies | Credit Bureau 2.0 / "Invisible Prime" (AI/ML credit scoring platform) | Ongoing rolling fundraises (HNW/Family Offices); on path to IPO | Global (Canada, USA) |
| ZayZoon | FinTech | Darcy Tuer (Co-founder and CEO), Tate Hackert (Co-founder and President), Jamie (Co-founder and CFO) | Earned Wage Access (EWA) with transaction fees and revenue shares | Employees and employers seeking recruitment/retention benefits | Wages-on-demand platform integrated with over 160 payroll providers | Post-Series B; 20 million USD capital facility | USA (Primary); exploring return to Canada |
| Pure Life Carbon Inc. | ClimateTech / AgTech | Don Ronald, Chris Vance (Sustainability Leader), Ryan Rand (CEO), Dr. Nick Savidov | Leasing (Substrate-as-a-Service) | Greenhouses (Controlled Environment Agriculture) and agricultural clusters | Advanced carbon-based soilless growing medium derived from bamboo | Raised over $20 million from retail investors; seeking $35 million institutional raise | North America (Canada, Mexico) and Europe |
| zs2 Technologies | ClimateTech | Scott Jenkins (Co-founder and CEO), Kristin Davis (Co-founder), Doug Brown (Co-founder) | Hybrid distribution model | Home builders, developers, and sustainability-focused customers | Magnesium cement-based structural insulated panels (SIPS) and CO2 capture | Raised 2.2 million CAD via convertible debenture; 2.7 million CAD SDTC grant | Canada (AB, BC, ON) and USA (AL, FL, UT, CO, CA, OR, WA, AK) |
| PurposeMed | HealthTech | Aman Banwait (Co-founder/CCO), Hussein (Physician/Co-founder), Pete (Co-founder) | B2C Direct-to-consumer and pharmacy margins | Underserved communities (LGBTQ2S+, ADHD, trans/non-binary) | Virtual care platforms (Freddy, Frida, Foria) | Debt financing (ATB, Government of Canada) and Friends & Family | Canada (National) and USA |
| Bolster (formerly Cost Certified) | ConstrucTech | Mike Bignold (CEO) | Fintech stack (take rate on GMV) and freemium model | SMB construction contractors and subcontractors | AI-driven estimating and cost-configurator tool | Raised 8.5 million USD seed round in 2021; Y Combinator graduate | USA (over 90% of customer base) |
| Fillip Fleet | FinTech | Alice Reimer (CEO), Brian Reimer (CPO) | SaaS and transaction-based fees | Small to mid-size business fleets (home builders, trades, franchises) | Digital/mobile-first vehicle payment solution and fuel card (Visa network) | Venture-backed (Staircase Ventures, Thinner Labs, Azure Capital) | Canada and North America |
| BlueMarvel AI | Industrial AI / Oil and Gas Tech | Carrie Lee (CEO) | Hybrid: Services, custom solutions, and SaaS | Industrial facilities and energy enterprises | Software for data ingress/egress to visualize safety and emission KPIs | Wholly owned subsidiary of Spartan Controls; no external investment sought | North America (Canada, USA) and International (Iraq) |
| Virtuo | PropTech | Casey Kachur (CEO and Co-founder), Nate Edwards (Co-founder) | B2B Partnership model and Subscription | Home builders, homeowners, mortgage brokers, and realtors | Digital concierge platform managing home buying and moving tasks | Cash flowing; closing a funding round | Canada and USA (Alberta, Rockland Park) |
| Nialli | ConstrucTech | Nancy Knowlton (CEO), Dave Martin (Co-founder) | SaaS with hardware components | General contractors, trade contractors, and project managers | Collaboration software and large-screen display systems for project management | Spun out from Nureva; internally funded/bootstrapped | North America (Canada, USA) |
| Bōde | PropTech | Robert Price (CEO), Jeff Jackson (Co-founder) | B2B Subscription and Marketplace-based platform | Independent homeowners and home builders/developers | Online real estate marketplace; automated transaction experience | Late seed fundraise round | Western Canada (AB, BC), Toronto (ON); USA expansion planned |
| Ownly | PropTech | Jason Hardy (Co-founder and CEO) | SaaS Plus (Subscription and per-verification fees) | Home builders, developers, and real estate brokers | E-commerce software for real estate; "Only Verified" buyer verification tool | Seed extension/Series A planned; backed by InterGen and National Bank | Canada (Calgary) and USA (TX, GA, FL) |
